...
ggsave("Fig_2_cognitivemaps_by_ome.png", device = "png", width = 8, height = 6, dpi = 300)
ggsave("Fig_2_cognitivemaps_by_ome.svg", device = svglite::svglite, width = 8, height = 6, dpi = 300)
ggsave("Fig_2_cognitivemaps_by_ome.eps", device = cairo_ps, width = 8, height = 6, dpi = 300)
...
map_long %>%
    ...
    ggplot(aes(x = map_var, y = mean_presence, fill = place)) +
      ...
      # title = "Obecność wybranych elementów na mapach poznawczych w zależności od miejsca ankietowania",
        x = NULL, y = "Respondents including the element (%)", fill = "Place of survey"
      ) +
      theme_minimal(base_size = 12) +
      theme(plot.title = element_text(face = "bold"), 
            axis.text.y = element_text(size = 9),
...
ggsave("Fig_3_cognitivemaps_by_place.png", device = "png", width = 8, height = 6, dpi = 300)
ggsave("Fig_3_cognitivemaps_by_place.svg", device = svglite::svglite, width = 8, height = 6, dpi = 300)
ggsave("Fig_3_cognitivemaps_by_place.eps", device = cairo_ps, width = 8, height = 6, dpi = 300)
```
